...
# endif
	...
	ysysloc=stsym("is68k"); /* should be mc68000 */
	ysysloc=stsym("__HAVE_68881__"); /* for GCC */
	ysysloc=stsym("CMU"); /* don't want this */
	ysysloc=stsym("MACH");
	ysysloc=stsym("CMUCS"); /* don't want this */
	ysysloc=stsym("MM_XXX"); /* should be MACHINE */
	ysysloc=stsym("BYTE_MSF"); /* should this be here? */
#endif
