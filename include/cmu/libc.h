...
extern int getstab(const char*, char**, char*);
extern int getsearch(const char*, char**, char*);
extern char* strarg(char**, const char*, const char*, char*, char*);
extern int stabarg(char**, const char*, const char*, char**, char*);
extern int searcharg(char**, const char*, const char*, char**, char*);
...
extern short shortarg(char**, const char*, const char*, short, short, short);
extern float getfloat(const char*, float, float, float);
extern float floatarg(char**, const char*, const char*, float, float, float);
extern double getdouble(const char*, double, double, double);
extern double doublearg(char**, const char*, const char*, double, double, double);
