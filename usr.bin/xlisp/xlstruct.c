...
*
* File:         xlstruct.c
* RCS:          $Header: xlstruct.c,v 1.2 89/11/25 05:47:24 mayer Exp $
* Description:  the defstruct facility
* Author:       David Michael Betz
* Created:      
* Modified:     Sat Nov 25 05:47:17 1989 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: xlstruct.c,v 1.2 89/11/25 05:47:24 mayer Exp $";
