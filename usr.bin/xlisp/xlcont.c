...
*
* File:         xlcont
* RCS:          $Header: xlcont.c,v 1.4 89/11/25 05:14:27 mayer Exp $
* Description:  xlisp special forms
* Author:       David Michael Betz
* Created:      
* Modified:     Sat Nov 25 05:14:10 1989 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: xlcont.c,v 1.4 89/11/25 05:14:27 mayer Exp $";
...
#ifdef WINTERP
placeform(place,value)		/* needed by w_resources.c:Wres_GetValues_ArgList_To_Lisp */
#else
