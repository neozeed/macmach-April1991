...
*
* File:         xllist.c
* RCS:          $Header: xllist.c,v 1.2 89/11/25 05:39:25 mayer Exp $
* Description:  xlisp built-in list functions
* Author:       David Michael Betz
* Created:      
* Modified:     Sat Nov 25 05:39:18 1989 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: xllist.c,v 1.2 89/11/25 05:39:25 mayer Exp $";
