...
*
* File:         xlmath.c
* RCS:          $Header: xlmath.c,v 1.3 89/11/25 05:40:35 mayer Exp $
* Description:  xlisp built-in arithmetic functions
* Author:       David Michael Betz
* Created:      
* Modified:     Sat Nov 25 05:40:27 1989 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: xlmath.c,v 1.3 89/11/25 05:40:35 mayer Exp $";
