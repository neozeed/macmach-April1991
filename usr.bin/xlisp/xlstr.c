...
*
* File:         xlstr.c
* RCS:          $Header: xlstr.c,v 1.2 89/11/25 05:44:25 mayer Exp $
* Description:  xlisp string and character built-in functions
* Author:       David Michael Betz
* Created:      
* Modified:     Sat Nov 25 05:44:13 1989 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: xlstr.c,v 1.2 89/11/25 05:44:25 mayer Exp $";
