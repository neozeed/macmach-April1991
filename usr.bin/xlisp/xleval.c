...
*
* File:         xleval.c
* RCS:          $Header: xleval.c,v 1.3 89/11/25 05:21:43 mayer Exp $
* Description:  xlisp evaluator
* Author:       David Michael Betz
* Created:      
* Modified:     Sat Nov 25 05:21:14 1989 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: xleval.c,v 1.3 89/11/25 05:21:43 mayer Exp $";
