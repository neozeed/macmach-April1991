...
*
* File:         xlfio.c
* RCS:          $Header: xlfio.c,v 1.4 89/11/25 05:24:44 mayer Exp $
* Description:  xlisp file i/o
* Author:       David Michael Betz
* Created:      
* Modified:     Sat Nov 25 05:24:25 1989 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: xlfio.c,v 1.4 89/11/25 05:24:44 mayer Exp $";
