...
#define	TEXT27	"Vernietig buffer: "
...
#define	TEXT61	"%%Negatief argument voor signaal is niet toegelaten"
...
#define	TEXT121	"%%!ENDWHILE zonder voorafgaande !WHILE in '%s'"
#define	TEXT122	"%%!WHILE zonder overeenkomstige !ENDWHILE in '%s'"
