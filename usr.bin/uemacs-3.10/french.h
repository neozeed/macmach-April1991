...
#define	TEXT27	"Tampon a detruire: "				/*"Kill buffer: "*/
...
#define	TEXT61	"%%detruire: argument negatif illegal"		/*"%%Negative argument to kill is illegal"*/
...
#define	TEXT121	"%%!ENDWHILE sans !WHILE dans '%s'"		/*"%%!ENDWHILE with no preceding !WHILE in '%s'"*/
#define	TEXT122	"%%!WHILE sans !ENDWHILE dans '%s'"			/*"%%!WHILE with no matching !ENDWHILE in '%s'"*/
