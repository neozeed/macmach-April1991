...
#ifndef lint
 static char rcsid[]=
 "$Header: /afs/andrew.cmu.edu/usr24/zon/mac2_51/new/rcs/src/RCS/snoop.c,v 1.1 89/10/12 16:24:11 zon Exp Locker: zon $ Purdue CS";
#endif
/*******************************************************************
...
/* $Log:	snoop.c,v $
 * Revision 1.1  89/10/12  16:24:11  zon
 * Initial revision
 * 
