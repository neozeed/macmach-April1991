/* Parameters for execution on a Mac2, for GDB, the GNU debugger.
...
/* we can do it */
#undef ATTACH_DETACH 1

/* Get rid of any system-imposed stack limit if possible.  */

/*#define SET_STACK_LIMIT_HUGE	not needed */
...
/* In the case of the Mac2, the frame's nominal address
...
#define MACH_ARCH_EXCEPTION_STRING	mach_mac2_exception_string

/* Thread flavors used in re-setting the T bit */
#define TBIT_FLAVOR		THREAD_STATE_FRAME
#define TBIT_FLAVOR_SIZE	THREAD_STATE_FRAME_COUNT
#define TBIT_SET(x,state)	((normal_exception_frame_t *)state)->f_sr =	\
				    ((normal_exception_frame_t *)state)->f_sr | 0x8000
#define TBIT_CLEAR(x,state)	((normal_exception_frame_t *)state)->f_sr =	\
				    ((normal_exception_frame_t *)state)->f_sr & 0x7fff
