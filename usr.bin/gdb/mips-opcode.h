 ...
 * HISTORY
 * $Log:	mips-opcode.h,v $
 * Revision 3.1  90/04/11  13:30:55  af
...
/* These first opcodes are special cases of the ones in the comments */
  ...
  {"move",	op_func(0, 33),	op_cond(0x3f,31)|0x3ff,/*addu*/	"d,s", 0},
  ...
  {"sllv",	op_func(0, 4),	op_func(0x3f, 0x3ff),		"d,t,s", 0},
  {"srlv",	op_func(0, 6),	op_func(0x3f, 0x3ff),		"d,t,s", 0},
  {"srav",	op_func(0, 7),	op_func(0x3f, 0x3ff),		"d,t,s", 0},
  ...
  {"tas a0",	op_func(0, 15),	op_func(0x3f, 0x3f),		"", 0},
  {"mfhi",	op_func(0, 16),	op_func(0x3f, 0x03ff0be0),	"d", 0},
  {"mthi",	op_func(0, 17),	op_func(0x3f, 0x1ffff),		"s", 0},
  {"mflo",	op_func(0, 18),	op_func(0x3f, 0x03ff0be0),	"d", 0},
  {"mtlo",	op_func(0, 19),	op_func(0x3f, 0x1ffff),		"s", 0},
  ...
  {"add",	op_func(0, 32),	op_func(0x3f, 0x3ff),		"d,s,t", 0},
  {"addu",	op_func(0, 33),	op_func(0x3f, 0x3ff),		"d,s,t", 0},
  {"sub",	op_func(0, 34),	op_func(0x3f, 0x3ff),		"d,s,t", 0},
  {"subu",	op_func(0, 35),	op_func(0x3f, 0x3ff),		"d,s,t", 0},
  {"and",	op_func(0, 36),	op_func(0x3f, 0x3f),		"d,s,t", 0},
  {"or",	op_func(0, 37),	op_func(0x3f, 0x3f),		"d,s,t", 0},
  {"xor",	op_func(0, 38),	op_func(0x3f, 0x3f),		"d,s,t", 0},
  {"nor",	op_func(0, 39),	op_func(0x3f, 0x3f),		"d,s,t", 0},
  {"slt",	op_func(0, 42),	op_func(0x3f, 0x3f),		"d,s,t", 0},
  {"sltu",	op_func(0, 43),	op_func(0x3f, 0x3f),		"d,s,t", 0},
  ...
  {"blez",	one(6),		one(0x3f) | 0x3f0000,		"s,b", 1},
  {"bgtz",	one(7),		one(0x3f) | 0x3f0000,		"s,b", 1},
...
/* co processor 0 instruction */
  ...
  {"cfc1",	op_rs_b11 (17, 2, 0),	op_rs_b11(0x3f, 0x1f, 0),	"t,C", 0},
  {"mtc1",	op_rs_b11 (17, 4, 0),	op_rs_b11(0x3f, 0x1f, 0),	"t,S", 0},
  {"ctc1",	op_rs_b11 (17, 6, 0),	op_rs_b11(0x3f, 0x1f, 0),	"t,C", 0},
