/* Macro definitions for running gdb on a Sun 4 running Mach 2.5.
...
#define MACH_ARCH_EXCEPTION_STRING	mach_sun4_exception_string

/* Thread flavors used in re-setting the T bit */

#define TBIT_FLAVOR		SUN_THREAD_STATE_REGS
#define TBIT_FLAVOR_SIZE	SUN_THREAD_STATE_REGS_COUNT
#define TBIT_SET(thread,x)	thread_single_step(thread,1)
#define TBIT_CLEAR(thread,x)	thread_single_step(thread,0)
