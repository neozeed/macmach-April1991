     ...
     value *args;
{
...
#ifdef	FIX_CALL_DUMMY_ALIGNED
    FIX_CALL_DUMMY_ALIGNED (dummy1, start_sp, funaddr, nargs, args, value_type);
#else
    FIX_CALL_DUMMY (dummy1, start_sp, funaddr, nargs, value_type);
#endif	FIX_CALL_DUMMY_ALIGNED
  }
  ...
  FLUSH_INFERIOR_CACHE(start_sp, sizeof dummy);
#endif
#ifdef STACK_ALIGN
