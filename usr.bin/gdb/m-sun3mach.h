...
#define STACK_END_ADDR 0xe000000
...
#define MACH_ARCH_EXCEPTION_STRING	mach_sun3_exception_string

/* Thread flavors used in re-setting the T bit */

#define TBIT_FLAVOR		SUN_THREAD_STATE_REGS
#define TBIT_FLAVOR_SIZE	SUN_THREAD_STATE_REGS_COUNT
#define TBIT_SET(x,state)	((struct sun_thread_state *)state)->sr =	\
				    ((struct sun_thread_state *)state)->sr | 0x8000
#define TBIT_CLEAR(x,state)	((struct sun_thread_state *)state)->sr =	\
