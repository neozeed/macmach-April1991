/* Definitions to make GDB run on an encore under Mach 2.5
...
/* Encore symbol table bugs ... */

#define ENCORE_MMAX_BUG
...
#define STACK_END_ADDR (0x7fffe000)
...
#define FP_REGNUM	 8		/* Contains address of executing stack frame */
#define PC_REGNUM	10		/* Contains program counter */
...
#define MACH_ARCH_EXCEPTION_STRING	mach_mmax_exception_string

/* Thread flavors used in re-setting the T bit */

#define TBIT_FLAVOR		NS32000_THREAD_STATE
#define TBIT_FLAVOR_SIZE	NS32000_THREAD_STATE_COUNT
#define TBIT_SET(x,state)	((struct ns32000_thread_state *)state)->psr =\
				  ((struct ns32000_thread_state *)state)->psr | 0x0002
#define TBIT_CLEAR(x,state)	((struct ns32000_thread_state *)state)->psr =\
				  ((struct ns32000_thread_state *)state)->psr & ~0x0002
