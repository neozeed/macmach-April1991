#ifndef lint
static char sccsid[] = "@(#)patch.c	5.9 (Berkeley) 2/18/88";
#endif not lint

char rcsid[] =
	"$Header: /afs/andrew.cmu.edu/usr24/zon/mac2_51/new/patch/RCS/patch.c,v 1.1 89/10/12 15:41:13 zon Exp Locker: zon $";
 ...
 *
 * $Log:	patch.c,v $
 * Revision 1.1  89/10/12  15:41:13  zon
 * Initial revision
 * 
