...
static void do_securekbd(), do_allowsends(), do_visualbell(), do_logging(),
  ...
  do_tekhide(), do_vtfont(), do_bltscroll();
...
MenuEntry vtMenuEntries[] = {
    ...
    { "bltscroll",	do_bltscroll, NULL },		/*  2 */
    { "reversevideo",	do_reversevideo, NULL },	/*  3 */
    { "autowrap",	do_autowrap, NULL },		/*  4 */
    { "reversewrap",	do_reversewrap, NULL },		/*  5 */
    { "autolinefeed",	do_autolinefeed, NULL },	/*  6 */
    { "appcursor",	do_appcursor, NULL },		/*  7 */
    { "appkeypad",	do_appkeypad, NULL },		/*  8 */
    { "scrollkey",	do_scrollkey, NULL },		/*  9 */
    { "scrollttyoutput",	do_scrollttyoutput, NULL },	/* 10 */
    { "allow132",	do_allow132, NULL },		/* 11 */
    { "cursesemul",	do_cursesemul, NULL },		/* 12 */
    { "visualbell",	do_visualbell, NULL },		/* 13 */
    { "marginbell",	do_marginbell, NULL },		/* 14 */
...
static void do_bltscroll (gw, closure, data)
    Widget gw;
    caddr_t closure, data;
{
    register TScreen *screen = &term->screen;

    screen->bltscroll = !screen->bltscroll;
    update_bltscroll();
}
...
void HandleBltscroll(w, event, params, param_count)
    Widget w;
    XEvent *event;
    String *params;
    Cardinal *param_count;
{
    handle_toggle (do_bltscroll, (int) term->screen.bltscroll,
		   params, *param_count, w, NULL, NULL);
}
