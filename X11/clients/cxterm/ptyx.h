...
/* VT window parameters */
	...
	Boolean		bltscroll;	/* whether we should bltscroll  */
...
#define REVERSE_VIDEO	0x80	/* true if screen white on black */
#define ORIGIN		0x100	/* true if in origin mode */
#define INSERT		0x200	/* true if in insert mode */
#define ENDLINE		0x400	/*
...
#define	ATTRIBUTES	0x37	/* attributes mask */
#define CHAR		0177
