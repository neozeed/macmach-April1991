...
#ifndef lint
static char *rcsid_cursor_c = "$XConsortium: cursor.c,v 1.8 90/06/06 09:18:31 jim Exp $";
#endif	/* lint */
...
#ifndef lint
static char rcs_id[] = "$XConsortium: cursor.c,v 1.8 90/06/06 09:18:31 jim Exp $";
#endif	/* lint */
