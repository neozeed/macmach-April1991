 ...
 * HISTORY
 * $Log:	md.c,v $
 * 29-Jan-91  Mary Thompson (mrt) at Carnegie-Mellon University
 *	Fixed parse_dep cannonicalization code to skip over leading
 *	escaped newlines like gcc sometimes puts out.
 *
 * 26-Feb-90  Zon Williamson (zon) at Carnegie-Mellon University
 *	Added code to allow backquoted newlines in *.d files.
 *
