...
#ifndef lint
static	char sccsid[] = "@(#)ld.c 1.1 87/12/16 SMI"; /* from UCB 5.4 85/11/26 */
#endif not lint
 ...
 * HISTORY
 * $Log:	ld.c,v $
 * Revision 1.4  88/10/15  20:25:52  gm0w
 * 	Returned incl.c to a separate module.
 * 	[88/10/15            gm0w]
 * 
 * Revision 1.3  88/10/10  14:00:45  gm0w
 * 	Updated to SUN version 3.5 and appended incl.c to the end of
 * 	this module.
 * 	[88/10/10            gm0w]
 * 
 **********************************************************************
...
#ifdef mac2
	"T",		"text",	(int *)&textbase,	(int *)&tsize,
	"Ttext",	"text",	(int *)&textbase,	(int *)&tsize,
	"Tdata",	"data",	(int *)&database,	(int *)&dsize,
#else
