 ...
 * HISTORY
 * $Log:	thread.c,v $
 * Revision 2.21  90/08/16  15:15:07  mrt
 ...
 * 	[90/05/08            dlb]
 * 
 * Revision 2.18  90/07/03  16:38:22  mrt
 * 	Add max_priority init to kernel_thread().
 * 	[90/06/20            dlb]
 * 	Initialize priority and do first priority computation in
 * 	thread_create.  Default maximum priority to BASEPRI_USER
 ...
 * 	[90/05/08            dlb]
 * 
 * Revision 2.17  90/03/27  18:46:44  dlb
 ...
 * 	       same reason.
 * 	Kernel monitor support (MACH_KM).
	...
	register thread_t	thread;
{
	...
	/*
	 *	Make sure that the thread's kernel stack
	 *	is accessable.
	 */
