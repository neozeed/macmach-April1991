 ...
 * HISTORY
 * $Log:	ufs_inode.c,v $
 * Revision 2.17  90/07/03  16:33:23  mrt
 * 	Remove MACH_XP conditionals.
 * 	[90/06/28            dlb]
 * 
 * Revision 2.16  89/12/22  16:25:59  rpd
 ...
 * 
 * Revision 2.15  89/12/22  15:51:55  rpd
 ...
 * 	[89/12/11            dlb]
 * 
 * Revision 2.14  89/10/10  10:47:36  mwyoung
 * 	Add runtime controls over FASTLINK use.
 * 	[89/10/07  19:12:37  mwyoung]
 * 
 * 	Make fast symbolic links available for all architectures.
 * 	[89/10/01            mwyoung]
 * 
 * Revision 2.13  89/10/03  19:21:52  rpd
 * 	In itrunc, zero rest of last block even when MACH_NBC.
 * 	[89/10/02  15:05:53  rpd]
 * 
...
/*
 *	Runtime controls over the use and creation of fast symbolic links.
 */
	...
	u_long length;
{
	...
	if (
#if	MULTIMAX
	    /* This may be a necessary check for the Multimax? */
