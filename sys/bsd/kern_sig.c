 ...
 */
#if	defined(vax) || defined(mips) || defined(NeXT) || defined(sequent) || defined(multimax) || defined(__GNUC__) || defined(i386)
#define SWITCH_INT	1
#else	
#define SWITCH_INT	0
#endif
...
core()
{
	 ...
	 *	into core file.
	 */
#ifdef	i386	/*XXX WHY IS THIS CONDITIONAL HERE? */
#else	i386
...
#define	USER_STACK_POINTER	SP
	...
	if (u.u_error == 0) {
		off_t off;
		/* In case of trouble, preserve uarea over kstack info */
