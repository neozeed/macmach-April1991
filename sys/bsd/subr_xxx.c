 ...
 * HISTORY
 * $Log:	subr_xxx.c,v $
 * Revision 2.10  90/08/30  10:59:00  bohman
 * 	Changes for mac2.
 * 	[90/08/28            bohman]
 * 
...
#if	defined(ibmrt) || defined(ns32000) || defined(sun) || defined(i386) || defined(mips) || defined(mac2)
imin(a, b)
{
...
#endif	defined(ibmrt) || defined(ns32000) || defined(sun) || defined(i386) || defined(mips) || defined(mac2)
